function results = Figure_5()
P = get_common_params();

cases(1) = struct('title','(A) A alone','Iapp1',200,'Iapp2',0,  'reverse_order',false,'from1',100,'to1',150,'from2',150,'to2',200);
cases(2) = struct('title','(B) AB-0 ms delay','Iapp1',200,'Iapp2',200,'reverse_order',false,'from1',100,'to1',150,'from2',150,'to2',200);
cases(3) = struct('title','(C) BA-0 ms delay','Iapp1',200,'Iapp2',200,'reverse_order',true, 'from1',100,'to1',150,'from2',150,'to2',200);
...
P.to2 = caseDef.to2;
P.Iapp1 = caseDef.Iapp1;
P.Iapp2 = caseDef.Iapp2;
