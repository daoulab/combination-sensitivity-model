...
results.panelA = panelA;
results.panelB = panelB;
end
...
P.gL = 2; P.gCa = 19;
P.arGA = 5; P.adGA = 0.18; P.VGA = -100;
P.arAM = 1.1; P.adAM = 0.19; P.VAM = 0;
...
P.init_cond = [P.Xinit;P.Xinit;P.INTinit;P.Xinit;P.INTinit;P.Xinit;P.INTinit;P.INTinit;P.INTinit; ...
               P.Xinit;P.Xinit;P.INTinit; ...
               0.01;0.01;0.01;0.01;0.01;0.01;0.01;0.01;0.01;0.01;0.01;0.01; ...
               0.01;0.01;0.01;0.01;0.01;0.01;0.01];
end

function out = run_panelA(P)
P.from1 = 100;
P.to1 = 150;
delay = 150;
P.from2 = 150 + delay;
...
function out = run_panelB(P)
tspan = 0:0.01:1500;
delayVals = linspace(0,300,10);
numSpikes = zeros(size(delayVals));

onsetA = 100;
durationA = 50;
durationB = 50;

for k = 1:numel(delayVals)
    d = delayVals(k);
    ...
    [~,sol] = ode23(@(t,sol) FTN_Network_P_local(t,sol,P), tspan, P.init_cond);
    VCSN = sol(:,64);
    spikeTimesModel = spike_times_local(VCSN,0.4);
    numSpikes(k) = length(spikeTimesModel);
end
...
hold on
plot(t, VA, 'Color', [0.46,0.01,0.65], 'LineWidth', 1); text(60, 0, 'A')
plot(t, VE1-step*i, 'Color', [0.14,0.55,0.16], 'LineWidth', 1); text(60, -step*i, 'E_1'); i=i+1;
plot(t, VINT1-step*i, 'Color', [0.14,0.55,0.16], 'LineWidth', 1); text(60, -step*i, 'I_1'); i=i+1;
plot(t, VE2-step*i, 'Color', [0.14,0.55,0.16], 'LineWidth', 1); text(60, -step*i, 'E_2'); i=i+1;
plot(t, VINT2-step*i, 'Color', [0.14,0.55,0.16], 'LineWidth', 1); text(60, -step*i, 'I_2'); i=i+1;
plot(t, VE3-step*i, 'Color', [0.14,0.55,0.16], 'LineWidth', 1); text(60, -step*i, 'E_3'); i=i+1;
plot(t, VINTA1-step*i, 'Color', [0.95,0.72,0.02], 'LineWidth', 1); text(60, -step*i, 'I_A_1'); i=i+1;
plot(t, VINTA2-step*i, 'Color', [0.95,0.72,0.02], 'LineWidth', 1); text(60, -step*i, 'I_A_2'); i=i+1;
plot(t, VINTA3-step*i, 'Color', [0.95,0.72,0.02], 'LineWidth', 1); text(60, -step*i, 'I_A_3'); i=i+1;
plot(t, VINTB-step*i, 'Color', [0.61,0.62,0.67], 'LineWidth', 1); text(60, -step*i, 'I_B'); i=i+1;
plot(t, VB-step*i, 'Color', [0.61,0.62,0.67], 'LineWidth', 1); text(60, -step*i, 'B'); i=i+1;
plot(t, VCSN-step*i, 'Color', [0.04,0.17,0.55], 'LineWidth', 1); text(60, -step*i, 'CSN');
...
function plot_panelB(S)
plot(S.delay, S.numSpikes, 'ko-', 'LineWidth', 1.5)
box off
xlabel('Inter-Stimulus Delay (ms)')
ylabel('Number of Spikes generated by the CSN')
